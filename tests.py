...
class TestUsers(unittest.TestCase):
    def setUp(self):
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:password@172.30.112.1:5432/database1'
...
#To execute, tests, run - python -m unittest discover -s tests - in the VSCode terminal
